...
public class ReviewHandler {
    ...
    private void validate(Review review) {
        var contraintsValidations = validator.validate(review);
        log.info("Constraints Validations {}", contraintsValidations);
        if(contraintsValidations.size() > 0) {
            var errorMessage = contraintsValidations
                    .stream()
